...
Route::redirect('/pricing', '/products', 301)->name('pricing');
...
Route::get('/terms-and-conditions', [PolicyController::class, 'terms'])->name('policies.terms');
Route::get('/privacy-policy', [PolicyController::class, 'privacy'])->name('policies.privacy');
Route::get('/refund-cancellation-policy', [PolicyController::class, 'refunds'])->name('policies.refunds');
Route::get('/shipping-delivery-policy', [PolicyController::class, 'shipping'])->name('policies.shipping');
Route::get('/warranty-support-policy', [PolicyController::class, 'warranty'])->name('policies.warranty');
Route::get('/vending-payment-refund-policy', [PolicyController::class, 'vendingPayments'])->name('policies.vending-payments');
Route::get('/grievance-redressal', [PolicyController::class, 'grievance'])->name('policies.grievance');
