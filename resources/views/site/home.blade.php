    ...
    <section class="tb-section pb-16">
        <div class="mx-auto max-w-6xl px-4">
            <div class="tb-customers tb-pitch-reveal p-6 md:p-8">
                <div class="flex flex-col gap-2 md:flex-row md:items-end md:justify-between"><div><span class="tb-pitch-kicker">Trusted collaborations</span><h2>Teams building with TwinBot</h2></div><p>Industrial teams and institutions working with TwinBot systems.</p></div>
                <div class="tb-customer-grid mt-7">@foreach (config('twinbot.assets.trusted_logos', []) as $logo)<div class="tb-customer-logo"><img src="{{ asset($logo) }}" alt="TwinBot trusted collaboration" /></div>@endforeach</div>
            </div>
        </div>
    </section>
